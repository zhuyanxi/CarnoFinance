...
const (
	...
	outputFileName  = "kc50_close_move_10pct_natural_days.csv"
	summaryFileName = "kc50_close_move_10pct_summary.md"
	bucketFileName  = "kc50_close_move_10pct_bucket_distribution.csv"
