...
const (
	...
	outputFileName  = "csi1000_close_move_5pct_natural_days.csv"
	summaryFileName = "csi1000_close_move_5pct_summary.md"
	bucketFileName  = "csi1000_close_move_5pct_bucket_distribution.csv"
...
func main() {
	...
	results := computeFirst5PctMoveDays(series)
...
func computeFirst5PctMoveDays(series []dailyClose) []moveResult {
